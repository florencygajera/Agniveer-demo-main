...
const INIT_SOLDIERS: Soldier[] = [
  ...
  { id: "6", soldierId: "AGN-2024-0201", name: "Vikram Nair", rank: "Sepoy", battalion: "PARA-1", state: "Kerala", city: "Thiruvananthapuram", dob: "2002-03-25", joining: "2024-02-01", blood: "A+", phone: "9876502001", email: "vikram.n@army.in", status: "active", medical: "Fit", physical: 94, weapons: 88, mental: 86, combat: 93, attendance: 97, discipline: 94, overall: 92 },
  { id: "7", soldierId: "AGN-2024-0202", name: "Ananya Krishnan", rank: "Sepoy", battalion: "PARA-1", state: "Tamil Nadu", city: "Chennai", dob: "2003-07-11", joining: "2024-02-01", blood: "B+", phone: "9876502003", email: "ananya.k@army.in", status: "active", medical: "Fit", physical: 80, weapons: 75, mental: 91, combat: 78, attendance: 95, discipline: 96, overall: 85.8 },
  { id: "8", soldierId: "AGN-2024-0203", name: "Rohit Sharma", rank: "Sepoy", battalion: "PARA-1", state: "MP", city: "Bhopal", dob: "2002-12-01", joining: "2024-02-01", blood: "O+", phone: "9876502005", email: "rohit.s@army.in", status: "active", medical: "Under Observation (Knee)", physical: 75, weapons: 69, mental: 72, combat: 71, attendance: 79, discipline: 74, overall: 73.3 },
  { id: "9", soldierId: "AGN-2024-0301", name: "Sourav Das", rank: "Sepoy", battalion: "BEN-2", state: "WB", city: "Kolkata", dob: "2002-01-14", joining: "2024-02-15", blood: "B+", phone: "9876503001", email: "sourav.d@army.in", status: "active", medical: "Fit", physical: 86, weapons: 80, mental: 83, combat: 85, attendance: 94, discipline: 88, overall: 86 },
  { id: "10", soldierId: "AGN-2024-0302", name: "Rekha Bose", rank: "Sepoy", battalion: "BEN-2", state: "WB", city: "Howrah", dob: "2003-04-20", joining: "2024-02-15", blood: "O+", phone: "9876503003", email: "rekha.b@army.in", status: "active", medical: "Fit", physical: 79, weapons: 71, mental: 90, combat: 75, attendance: 96, discipline: 94, overall: 84.2 },
  { id: "11", soldierId: "AGN-2024-0303", name: "Amit Ghosh", rank: "Sepoy", battalion: "BEN-2", state: "WB", city: "Durgapur", dob: "2002-09-02", joining: "2024-02-15", blood: "A+", phone: "9876503005", email: "amit.g@army.in", status: "active", medical: "Fit", physical: 72, weapons: 65, mental: 68, combat: 69, attendance: 80, discipline: 72, overall: 71 },
  { id: "12", soldierId: "AGN-2024-0304", name: "Ranjit Singh", rank: "Lance Naik", battalion: "BEN-2", state: "Punjab", city: "Ludhiana", dob: "2001-07-25", joining: "2024-02-15", blood: "B+", phone: "9876503007", email: "ranjit.s@army.in", status: "active", medical: "Fit", physical: 90, weapons: 92, mental: 84, combat: 91, attendance: 98, discipline: 95, overall: 91.7 },
...
const BATS = ["RR-1", "PARA-1", "BEN-2", "MAR-4"]

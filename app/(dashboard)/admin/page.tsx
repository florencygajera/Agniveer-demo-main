...
const BATTALIONS: Battalion[] = [
  ...
  { id: "PARA-1", code: "PARA-1", name: "2nd Parachute Regiment", location: "Agra, Uttar Pradesh", commander: "Col. S.P. Mehta", score: 84.4, total: 4, active: 4, onLeave: 0, scoreAbove85: 3, physical: 84, weapons: 79, mental: 82, accentColor: "border-l-violet-500" },
  { id: "BEN-2", code: "BEN-2", name: "3rd Bengal Regiment", location: "Kolkata, West Bengal", commander: "Col. D.K. Roy", score: 83.2, total: 4, active: 4, onLeave: 0, scoreAbove85: 2, physical: 82, weapons: 77, mental: 81, accentColor: "border-l-sky-500" },
